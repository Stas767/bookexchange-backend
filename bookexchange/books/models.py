...
class BookCard(models.Model):
    ...
    author = models.ManyToManyField(
        "Author", verbose_name="Автор книги", related_name="book_cards"
    )
    genre = models.ManyToManyField(
        "Genre", verbose_name="Жанр", related_name="book_cards"
    )
...
class Advert(models.Model):
    # объявление
    pub_date = models.DateTimeField("Дата и время создания", auto_now_add=True)
    owner = models.ForeignKey(
        User,
        on_delete=models.CASCADE,
...
class Author(models.Model):
    ...
    bio = models.TextField("Биография", max_length=settings.LONG_FIELD_LENGTH)
